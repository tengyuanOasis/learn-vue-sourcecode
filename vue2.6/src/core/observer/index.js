...
export class Observer {
  ...
  /*
    将Observer实例绑定到data的__ob__属性上面去，observe的时候会先检测是否已经有__ob__对象存放Observer实例了，def方法定义可以参考https://github.com/vuejs/vue/blob/dev/src/core/util/lang.js#L16
    */
...
export function defineReactive(
  ...
  Object.defineProperty(obj, key, {
    ...
    get: function reactiveGetter() {
      ...
      // 会执行到 dep.depend(Dep.target), 将 Watcher 添加到 Dep 对象的 Watcher 列表中
      if (Dep.target) {
        dep.depend();
        if (childOb) {
          childOb.dep.depend();
